/**
 * MediaPipe Pose Landmark Indices (33 standardized keypoints)
 * Standard reference: https://developers.google.com/mediapipe/solutions/vision/pose_landmarker
 */
...
/**
 * Standard skeletal connections between landmarks for drawing skeletons
 */
...
/**
 * Clean fitness-oriented skeletal connections for fast, uncluttered real-time rendering.
 * Omits noisy facial mesh and hand/finger webs.
 * Arms terminate cleanly at the wrists.
 */
export const FITNESS_POSE_CONNECTIONS: [number, number][] = [
...
/**
 * Dedicated visual keypoints list for the fitness skeleton (15 keypoints total).
 * Excludes facial landmarks (except nose as head reference) and all finger joints.
 */
export const FITNESS_KEYPOINTS = [
  POSE_LANDMARKS.NOSE,
